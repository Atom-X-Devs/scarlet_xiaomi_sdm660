...
typedef enum {
	...
	MAX98927_Meas_ADC_Thermal_Warning_Threshhold_MEAS_ADC_WARN_THRESH_Mask =
		(0xff << 0),

	MAX98927_Meas_ADC_Thermal_Shutdown_Threshhold = 0x0015,

	MAX98927_Meas_ADC_Thermal_Shutdown_Threshhold_MEAS_ADC_SHDN_THRESH_Mask =
		(0xff << 0),

	MAX98927_Meas_ADC_Thermal_Hysteresis = 0x0016,

	MAX98927_Meas_ADC_Thermal_Hysteresis_MEAS_ADC_THERM_HYST_Mask =
		(0x1f << 0),
	...
	MAX98927_Env_Tracker_Vout_Headroom_ENV_TRACKER_BST_VOUT_HEADROOM_Mask =
		(0x1f << 0),

	MAX98927_Env_Tracker_Boost_Vout_Delay = 0x0083,

	MAX98927_Env_Tracker_Boost_Vout_Delay_ENV_TRACKER_BST_VOUT_DELAY_Mask =
		(0x1f << 0),
	...
	MAX98927_Env_Tracker__Boost_Vout_ReadBack_ENV_TRACKER_BST_VOUT_RD_Mask =
		(0x1f << 0),
...
typedef enum {
	...
	MAX98937_Meas_ADC_Thermal_Warning_Threshhold_MEAS_ADC_WARN_THRESH_Mask =
		(0xff << 0),

	MAX98937_Meas_ADC_Thermal_Shutdown_Threshhold = 0x0015,

	MAX98937_Meas_ADC_Thermal_Shutdown_Threshhold_MEAS_ADC_SHDN_THRESH_Mask =
		(0xff << 0),

	MAX98937_Meas_ADC_Thermal_Hysteresis = 0x0016,

	MAX98937_Meas_ADC_Thermal_Hysteresis_MEAS_ADC_THERM_HYST_Mask =
		(0x1f << 0),
	...
	MAX98937_Meas_ADC_Base_Divide_MSByte_MEAS_ADC_BASE_DIV_Mask =
		(0xff << 0),

	MAX98937_Meas_ADC_Base_Divide_LSByte = 0x0044,

	MAX98937_Meas_ADC_Base_Divide_LSByte_MEAS_ADC_BASE_DIV_Mask =
		(0xff << 0),
	...
	MAX98937_Meas_ADC_Chan_0_Filt_Config_MEAS_ADC_CH0_FILT_AVG_Mask =
		(0x7 << 0),

	MAX98937_Meas_ADC_Chan_0_Filt_Config_MEAS_ADC_CH0_FILT_AVG_001 =
		(0x0 << 0),
	MAX98937_Meas_ADC_Chan_0_Filt_Config_MEAS_ADC_CH0_FILT_AVG_011 =
		(0x2 << 0),
	MAX98937_Meas_ADC_Chan_0_Filt_Config_MEAS_ADC_CH0_FILT_AVG_101 =
		(0x4 << 0),
	MAX98937_Meas_ADC_Chan_0_Filt_Config_MEAS_ADC_CH0_FILT_EN = (0x1 << 3),

	MAX98937_Meas_ADC_Chan_1_Filt_Config = 0x0049,
	MAX98937_Meas_ADC_Chan_1_Filt_Config_MEAS_ADC_CH1_FILT_AVG_Mask =
		(0x7 << 0),

	MAX98937_Meas_ADC_Chan_1_Filt_Config_MEAS_ADC_CH1_FILT_AVG_001 =
		(0x0 << 0),
	MAX98937_Meas_ADC_Chan_1_Filt_Config_MEAS_ADC_CH1_FILT_AVG_011 =
		(0x2 << 0),
	MAX98937_Meas_ADC_Chan_1_Filt_Config_MEAS_ADC_CH1_FILT_AVG_101 =
		(0x4 << 0),
	MAX98937_Meas_ADC_Chan_1_Filt_Config_MEAS_ADC_CH1_FILT_EN = (0x1 << 3),

	MAX98937_Meas_ADC_Chan_2_Filt_Config = 0x004a,
	MAX98937_Meas_ADC_Chan_2_Filt_Config_MEAS_ADC_CH2_FILT_AVG_Mask =
		(0x7 << 0),

	MAX98937_Meas_ADC_Chan_2_Filt_Config_MEAS_ADC_CH2_FILT_AVG_001 =
		(0x0 << 0),
	MAX98937_Meas_ADC_Chan_2_Filt_Config_MEAS_ADC_CH2_FILT_AVG_011 =
		(0x2 << 0),
	MAX98937_Meas_ADC_Chan_2_Filt_Config_MEAS_ADC_CH2_FILT_AVG_101 =
		(0x4 << 0),
	...
	MAX98937_Brownout_threshold_hysterysis_BDE_VTHRESH_HYST_Mask =
		(0xff << 0),

	MAX98937_Brownout_AMP_limiter_attack_release = 0x005b,
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_Mask =
		(0xf << 0),

	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_0001 =
		(0x0 << 0),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_0011 =
		(0x2 << 0),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_0101 =
		(0x4 << 0),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_0111 =
		(0x6 << 0),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_1001 =
		(0x8 << 0),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_1011 =
		(0xa << 0),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_1101 =
		(0xc << 0),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_RLS_1111 =
		(0xe << 0),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_Mask =
		(0xf << 4),

	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_0001 =
		(0x0 << 4),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_0011 =
		(0x2 << 4),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_0101 =
		(0x4 << 4),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_0111 =
		(0x6 << 4),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_1001 =
		(0x8 << 4),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_1011 =
		(0xa << 4),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_1101 =
		(0xc << 4),
	MAX98937_Brownout_AMP_limiter_attack_release_AMP_LIM_ATK_1111 =
		(0xe << 4),

	MAX98937_Brownout_AMP_gain_attack_release = 0x005c,
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_Mask =
		(0xf << 0),

	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_0001 =
		(0x0 << 0),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_0011 =
		(0x2 << 0),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_0101 =
		(0x4 << 0),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_0111 =
		(0x6 << 0),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_1001 =
		(0x8 << 0),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_1011 =
		(0xa << 0),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_1101 =
		(0xc << 0),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_RLS_1111 =
		(0xe << 0),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_Mask =
		(0xf << 4),

	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_0001 =
		(0x0 << 4),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_0011 =
		(0x2 << 4),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_0101 =
		(0x4 << 4),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_0111 =
		(0x6 << 4),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_1001 =
		(0x8 << 4),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_1011 =
		(0xa << 4),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_1101 =
		(0xc << 4),
	MAX98937_Brownout_AMP_gain_attack_release_AMP_GAIN_ATK_1111 =
		(0xe << 4),
	...
	MAX98937_Brownout__level_1_amp_1_control_1_BDE_L1_AMP1_LIM_Mask =
		(0xf << 0),

	MAX98937_Brownout__level_1_amp_1_control_2 = 0x0060,

	MAX98937_Brownout__level_1_amp_1_control_2_BDE_L1_AMP1_CLIP_Mask =
		(0x3f << 0),

	MAX98937_Brownout__level_1_amp_1_control_3 = 0x0061,

	MAX98937_Brownout__level_1_amp_1_control_3_BDE_L1_AMP1_GAIN_Mask =
		(0x3f << 0),
	...
	MAX98937_Brownout__level_2_amp_1_control_1_BDE_L2_AMP1_LIM_Mask =
		(0xf << 0),

	MAX98937_Brownout__level_2_amp_1_control_2 = 0x0064,

	MAX98937_Brownout__level_2_amp_1_control_2_BDE_L2_AMP1_CLIP_Mask =
		(0x3f << 0),

	MAX98937_Brownout__level_2_amp_1_control_3 = 0x0065,

	MAX98937_Brownout__level_2_amp_1_control_3_BDE_L2_AMP1_GAIN_Mask =
		(0x3f << 0),
	...
	MAX98937_Brownout__level_3_amp_1_control_1_BDE_L3_AMP1_LIM_Mask =
		(0xf << 0),

	MAX98937_Brownout__level_3_amp_1_control_2 = 0x0068,

	MAX98937_Brownout__level_3_amp_1_control_2_BDE_L3_AMP1_CLIP_Mask =
		(0x3f << 0),

	MAX98937_Brownout__level_3_amp_1_control_3 = 0x0069,

	MAX98937_Brownout__level_3_amp_1_control_3_BDE_L3_AMP1_GAIN_Mask =
		(0x3f << 0),
	...
	MAX98937_Brownout__level_4_amp_1_control_1_BDE_L4_AMP1_LIM_Mask =
		(0xf << 0),

	MAX98937_Brownout__level_4_amp_1_control_2 = 0x006c,

	MAX98937_Brownout__level_4_amp_1_control_2_BDE_L4_AMP1_CLIP_Mask =
		(0x3f << 0),

	MAX98937_Brownout__level_4_amp_1_control_3 = 0x006d,

	MAX98937_Brownout__level_4_amp_1_control_3_BDE_L4_AMP1_GAIN_Mask =
		(0x3f << 0),
	...
	MAX98937_Env_Tracker_Vout_Headroom_ENV_TRACKER_BST_VOUT_HEADROOM_Mask =
		(0x1f << 0),

	MAX98937_Env_Tracker_Boost_Vout_Delay = 0x0074,

	MAX98937_Env_Tracker_Boost_Vout_Delay_ENV_TRACKER_BST_VOUT_DELAY_Mask =
		(0x3f << 0),
	MAX98937_Env_Tracker_Boost_Vout_Delay_ENV_TRACKER_BDE_MODE = (0x1 << 7),

	MAX98937_Env_Tracker_Release_Rate = 0x0075,
	MAX98937_Env_Tracker_Release_Rate_ENV_TRACKER_RLS_RATE_Mask =
		(0x7 << 0),
	...
	MAX98937_Env_Tracker_Release_Rate_ENV_TRACKER_RLS_RATE_SCALE_Mask =
		(0x3 << 4),

	MAX98937_Env_Tracker_Release_Rate_ENV_TRACKER_RLS_RATE_SCALE_01 =
		(0x0 << 4),
	MAX98937_Env_Tracker_Release_Rate_ENV_TRACKER_RLS_RATE_SCALE_11 =
		(0x2 << 4),
	...
	MAX98937_Env_Tracker__Boost_Vout_ReadBack_ENV_TRACKER_BST_VOUT_RD_Mask =
		(0x1f << 0),
