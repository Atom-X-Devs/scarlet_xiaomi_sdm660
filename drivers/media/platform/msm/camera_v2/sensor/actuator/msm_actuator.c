	...
	const struct i2c_device_id *id)
{
	...
	act_ctrl_t->msm_sd.sd.entity.function =
#else
	act_ctrl_t->msm_sd.sd.entity.group_id =
#endif
...
#ifdef CONFIG_XIAOMI_OSSCAM
	msm_actuator_t->msm_sd.sd.entity.function =
#else
	msm_actuator_t->msm_sd.sd.entity.group_id =
#endif
		MSM_CAMERA_SUBDEV_ACTUATOR;
