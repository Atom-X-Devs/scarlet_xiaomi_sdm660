 ...
 * let's just code a const table for it until we can actually get the
 * right clock rate.
 */
static const struct dw_hdmi_audio_tmds_n rockchip_weird_tmds_n_table[] = {
...
static const struct dw_hdmi_plat_data rk3288_hdmi_drv_data = {
	...
	.tmds_n_table = rockchip_weird_tmds_n_table,
};
